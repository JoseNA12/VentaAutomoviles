create procedure usp_SelectPedidosPendientes(@fecha date)
as
	...
	select cb.[name] as marca,ca.[model] as modelo,car.[price] as precio,cu.[name] as nombre, cu.[lastname] as apellido,u.[email] as correo, os.[statusName] as "status"
	from Car ca
