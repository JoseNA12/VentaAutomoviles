...
as
	...
	select o.order_id as idOrden, cb.[name] as marca,ca.[model] as modelo,car.[price] as precio,cu.[name] as nombre, cu.[lastname] as apellido,u.[email] as correo, cu.phone as telefono
	from Car ca
...
begin
	...
	Where os.[statusName]='Entregado' OR os.[statusName]='Enviado'
end